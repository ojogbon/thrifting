...
<body>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-6 hero-text">
					<h2>Invest now, <span>Thrift</span> <br>Save more</h2>
					<h4>,go modern and keep your money save</h4>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6 offset-lg-6 about-text">
					<h2>What we do</h2>
					<h5>We modernize means of doing thrift .</h5>
					<p>We make thrift so mush easy and accessible. through the use of technology and web smooth structure.</p>
			...
			<div class="row">
				...
				<div class="col-md-6 col-lg-4 feature">
					...
					<div class="feature-content">
						<h4>Safe & Secure</h4>
						<p>Your Money is surely with the right people, save and flexible. </p>
				...
				<div class="col-md-6 col-lg-4 feature">
					...
					<div class="feature-content">
						<h4>Account</h4>
						<p>All transaction are well documented. All of your financial info are easily accessible. </p>
						<a href="" class="readmore">Readmore</a>
					</div>
				</div>
				<!-- feature -->
				...
				<div class="col-md-6 col-lg-4 feature">
					...
					<div class="feature-content">
						<h4>Easy Cash Out</h4>
						<p>All founds can be gotten as at when desired. </p>
						<a href="" class="readmore">Readmore</a>
					</div>
				</div>
				<!-- feature -->
	...
	<section class="process-section spad">
		<div class="container">
			<div class="section-title text-center">
				<h2>Get Started With Thrift</h2>
				<p>Start saving with coolThrift. It’s fun, easy, and takes only a few minutes! </p>
			</div>
			<div class="row">
				<div class="col-md-4 process">
					<div class="process-step">
						...
						<p>All you need to start your thrift is a simple SignUp. </p>
					</div>
				</div>
				<div class="col-md-4 process">
					<div class="process-step">
						...
						<h4>Save More</h4>
						<p>Then save as mush as you can. </p>
					</div>
				</div>
				<div class="col-md-4 process">
					<div class="process-step">
						...
						<h4>Get More</h4>
						<p>Boom! just like magic, you get as mush as you wish. </p>
					</div>
				</div>
			</div>
		</div>
	...
	<section class="team-section spad">
		<div class="container">
			<div class="section-title text-center">
				<h2>Meet Our Team</h2>
				<p>We are wonderful, cool, and great.</p>
			</div>
		</div>
		<div class="team-members clearfix">
            ...
            <div class="member">
                <div class="member-text">
                    ...
                    <h2>Lawal Usman Olawale</h2>
                    <span>ND II Computer Science</span>
                </div>
                ...
                <div class="member-info">
                    ...
                    <p>He is a professional java programmer, he is calm, good looking,sensitive and intelligent.</p>
                </div>
            </div>
            <!-- Team member -->
            <!-- Team member -->
				...
				<div class="col-lg-8 push-8">
					...
					<div class="review-text-slider owl-carousel">
						<div class="review-text">
							<p>"Thrift is exciting because it shows how easy it can be to become a success. This Modern method is better than the physical for large transactions, because physical cash currency can get pretty inconvenient.”</p>
						</div>
						<div class="review-text">
                            <p>"Thrift is exciting because it shows how easy it can be to become a success. This Modern method is better than the physical for large transactions, because physical cash currency can get pretty inconvenient.”</p>
						</div>
