...
<head>
    ...
    <title>wesepounds | History</title>
                            ...
                            <div class="card alert">
                                ...
                                <div class="card-body">
                                    <table class="table table-responsive">
                                        ...
                                        $sql = "SELECT *  FROM `thrifttransaction` where   user_id='".$user_id."'";
                                        ...
                                        foreach ($markedTransactions as $markedTransaction => $value){
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if ( $markedTransactions[$markedTransaction]["status"] == "pending") {
                                                        ?>
                                                        <i class="ti-face-smile"> Pending..</i>
                                                        <?php
                                                    }elseif ($markedTransactions[$markedTransaction]["status"] == "marked"){
                                                    ?>
                                                        <i class="ti-check"></i>
                                                        <?php
                                                    }elseif ($markedTransactions[$markedTransaction]["status"] == "0"){
                                                        ?>
                                                        <i class="ti-loop"> await</i>
                                                    <?php
                                                    }
                                                    ?>
                                                </td>
                                                <td><?php echo $markedTransactions[$markedTransaction]["date"]?></td>
                                            </tr>
                                            <?php
                                        }
                                        ?>
