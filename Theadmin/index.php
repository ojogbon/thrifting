...
<body>
  ...
  <div class="header">
       <div class="pull-left">
           <div class="logo"><a href="index.php"><span style="font-size:9px;">THRIFT ADMIN</span></a></div>
                                ...
                                <div class="card-body">
                                    <div class="basic-form">
                                        <form method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                <p>Password </p>
                                                <input type="password" name="admin_password" class="form-control input-default " placeholder="Password" required>
                                            </div>
								...
								<button type="submit" name="add_staff" class="btn btn-primary btn-flat m-b-30 m-t-30">Login</button>
                                        ...
                                        <?php
                                                    			 if(isset($_POST["add_staff"])){
                                                                  ...
                                                                  $select_query = "select id from admin where username= '$admin_usename' and password = '$admin_password'";
                                                                  $my_select = mysqli_query($mycon,$select_query);

                                                                  if(mysqli_num_rows($my_select) > 0){
                                                                      $_SESSION["adminID"] =  mysqli_fetch_array($my_select)["id"];
